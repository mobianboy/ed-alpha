...
<tr><th><label for="profile_type"><?php _e('Profile Type') ?></label></th>
<td><select name="profile_type" id="profile_type">
<?php
...
foreach($profile_types as $key => $val) {
  $selected = (get_user_meta($profileuser->ID, 'profile_type', TRUE) == $key) ? 'selected' : ''; ?>
